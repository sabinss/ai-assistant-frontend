    ...
    <>
      ...
      <div className="flex h-[100vh] items-center justify-center">
        <div className="mx-10 flex h-[580px] w-full overflow-hidden rounded-xl border-2 border-slate-100 shadow-lg lg:w-[60%]">
          <div className="md:flex hidden w-1/2 flex-col justify-center bg-gradient-to-b from-[#174894] to-[#242866]">
            <h1 className="text-center text-lg text-white">
              AI Support Agent
            </h1>
            <Image
              className="mx-auto rounded-md mt-4 w-[80%]"
              src={robotImage}
              alt="auth-img"
            />
          ...
          <div className="flex min-h-[100%] md:w-1/2 w-full flex-col justify-center rounded-e-xl">
            {children}
          </div>
        </div>
      </div>
