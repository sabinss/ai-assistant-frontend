...
const ChatList: React.FC<ChatListProps> = ({ messages }: ChatListProps) => {
    ...
    return (
        <div ref={chatListRef} className=" flex px-2 h-full flex-col gap-5 w-full overflow-y-scroll">
            ...
            {isMessageLoading && (
                ...
                >
                    <MessageDiv msg={{ sender: botName, message: "Thanks for waiting! If it were a human, you might be waiting for ages just for them to type this. Lucky for you, I'm quicker than a turbo-charged turtle. Just a sec!", time: "", id: "loading" }} />
                </motion.div>
