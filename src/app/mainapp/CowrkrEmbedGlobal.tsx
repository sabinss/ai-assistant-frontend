...
/**
 * Floating chat widget for the whole main app (all routes under /mainapp).
 * Loads public/embedchat.js once; keeps bubble visible while navigating.
 */
export default function CowrkrEmbedGlobal() {
  ...
  return (
    <div
      ...
      className="pointer-events-none fixed h-px w-px overflow-hidden whitespace-nowrap border-0 p-0 [clip:rect(0,0,0,0)]"
      aria-hidden
    />
  )
}
