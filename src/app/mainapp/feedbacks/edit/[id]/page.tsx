...
const EditFeedback = ({ params, type }) => {
    ...
    useEffect(() => {
        async function fetchData() {
            try {
                ...
                setModifiedAnswer(feedback.modified_answer || feedback.conversation.answer);
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            const response = await http.patch(`/feedback/${feedback_id}`, {
    ...
    return (
        <div className="w-full p-4 bg-white rounded-md">
            <h1 className="text-2xl mb-10">Edit Feedback</h1>
            <div className="flex flex-col gap-4">
                ...
                <div className="flex">
                    ...
                    <textarea
                        disabled
                        className="w-4/5 rounded-md px-4 py-2 border border-[#CCCCCC] bg-[#e7e7e7]"
                        rows={5}
                ...
                <div className="flex">
                    ...
                    <textarea
                        ...
                        rows={5}
                        className="w-4/5 rounded-md px-4 py-2 border border-[#CCCCCC] bg-inherit"
                ...
                <div className="buttons flex gap-2 justify-end">
                    {type === "drawer" ? (
                        <>
                            ...
                            <DrawerClose>
                                <Button className="bg-gradient-to-b from-white to-[#CDCDCD] border-[#CDCDCD] border text-[#535353] font-medium rounded-md">
                                    Cancel
                                </Button>
                            </DrawerClose>
                        </>
